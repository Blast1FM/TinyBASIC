...
2380 GOTO 2350
2390 REM IF RND(99) < 25 THEN LET E=(G+L-F+C)/10
2390 IF 24<25 THEN LET E=(G+L-F+C)/10
2400 REM WAR AND PLAGUE
2410 REM IF RND(99)>15 THEN GOTO 2880
2410 IF 99>15 THEN GOTO 2880
2420 LET W=25
...
2570 REM IF RND(99)<W THEN GOTO 2610
2570 IF 1<W THEN GOTO 2610
...
2690 LET U=-(A+T)/2
2710 LET Z=-D/2
2720 REM IF R>RND(99) THEN GOTO 2760
2720 IF R>99 THEN GOTO 2760
...
2870 LET H=N*80
2880 LET N=P-S-K-M
2890 REM IF RND(99)>4 THEN GOTO 2940
2890 IF 5>4 THEN GOTO 2940
2910 PRINT "THE BLACK PLAGUE STRIKES"
2920 LET V=N/2
2930 GOTO 2970
2940 REM IF RND(99) > 20 THEN GOTO 2980
2940 IF 1>20 THEN GOTO 2980
2950 PRINT "A POX EPIDEMIC BREAKS OUT"
2960 LET V=N/20
2970 LET N=N-V
2980 REM LET B=(N*RND(5)+9)/100+1
2980 LET B=(N*3+9)/100+1
2990 REM LET D=(N*RND(3)+4)/100
2990 LET D=(N*3+4)/100
